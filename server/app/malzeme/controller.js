...
const controller = {
  ...
  create: async (req, res) => {
    ...
    try {
      ...
      if (!data.malzemeTipi) return response.error(req, res, HizmetName, rota, message.add.error, message.special.error.malzemeTipiGerekli);
      if (!data.birimId) return response.error(req, res, HizmetName, rota, message.add.error, message.special.error.birimGerekli);
      if (!data.subeId) return response.error(req, res, HizmetName, rota, message.add.error, message.special.error.subeGerekli);
      if (!data.sabitKoduId) return response.error(req, res, HizmetName, rota, message.add.error, message.special.error.sabitKoduGerekli);
      if (!data.markaId) return response.error(req, res, HizmetName, rota, message.add.error, message.special.error.markaGerekli);
      if (!data.modelId) return response.error(req, res, HizmetName, rota, message.add.error, message.special.error.modelGerekli);
