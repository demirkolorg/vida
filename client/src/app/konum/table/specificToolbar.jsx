...
import { Konum_HierarchyDialog } from "../dialogs/HierarchyDialog";
import { Konum_Store } from "../constants/store";

export const Konum_SpecificToolbar = () => {
  const [isHierarchyOpen, setIsHierarchyOpen] = React.useState(false);
  const datas = Konum_Store(state => state.datas);
  ...
  const handleMalzemeSort = () => {
    ...
    Konum_Store.getState().SortByMalzemeCount();
  };
