// src/components/modals/BulkIadeValidationModal.jsx
'use client';

import { AlertTriangle, User, Package, XCircle } from 'lucide-react';
...
export function BulkIadeValidationModal({ 
  isOpen, 
  onClose, 
  onProceed, 
  validationResult 
      ...
      <DialogContent className="sm:max-w-4xl max-h-[90vh] flex flex-col">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-destructive">
            ...
            Toplu İade İşlemi - Doğrulama Hatası
          </DialogTitle>
        </DialogHeader>
            ...
            <Card className="bg-blue-50 border-blue-200 dark:bg-blue-950/20 dark:border-blue-800">
              <CardContent className="pt-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-blue-800 dark:text-blue-200 mb-1">Toplu İade Kuralı</p>
                    <p className="text-sm text-blue-700 dark:text-blue-300">
                      Toplu iade işleminde seçilen tüm malzemeler aynı personelde zimmetli olmalıdır. 
                      Farklı personellerin malzemelerini aynı anda iade edemezsiniz.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="bg-amber-50 border-amber-200 dark:bg-amber-950/20 dark:border-amber-800">
              <CardContent className="pt-4">
                ...
                <ul className="text-sm text-amber-700 dark:text-amber-300 space-y-1 list-disc list-inside">
                  ...
                  <li>Farklı personellerin malzemelerini ayrı ayrı iade işlemlerine tabi tutun</li>
        ...
        <DialogFooter className="gap-2">
          ...
          {validPersonel && validMalzemeler && validMalzemeler.length > 0 && (
            ...
            >
              Sadece {validPersonel.ad} Malzemelerini İade Et ({validMalzemeler.length})
            </Button>
          )}
        </DialogFooter>
      </DialogContent>
