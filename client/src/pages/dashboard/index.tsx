  ...
  const HareketListItem = ({ hareket }) => (
    <div className="flex items-center justify-between py-3">
      ...
      <div className="text-right">
        <Badge
          variant={
            hareket.hareketTuru === "Zimmet"
              ? "destructive"
              : hareket.hareketTuru === "Iade"
              ? "success"
              : hareket.hareketTuru === "Devir"
              ? "warning"
              : "secondary"
          }
          className="text-xs"
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-muted-foreground">
              ...
              Malzeme Yönetim Sistemine Genel Bakış
            </p>
          </div>
                ...
                {stats.sonHareketler.length > 0 ? (
                  stats.sonHareketler.map((hareket) => (
                    <div key={hareket.id}>
                      ...
                      {stats.sonHareketler.indexOf(hareket) <
                        stats.sonHareketler.length - 1 && <Separator />}
                    </div>
                  ))
                ) : (
