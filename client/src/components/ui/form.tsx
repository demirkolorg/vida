...
function FormControl({ ...props }: React.ComponentProps<typeof Slot>) {
  ...
  if (!error) {
    aria = `${formDescriptionId}`;
  } else if(formMessageId) {
    aria = `${formDescriptionId} ${formMessageId}`;
  } else (
    aria=""
  )
  ...
  return <Slot data-slot="form-control" id={formItemId} aria-describedby={"aria-describedby"} aria-invalid={!!error} {...props} />;
}
