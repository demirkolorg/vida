...
export function ThemeSelector() {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <ThemeGalleryDialog isOpen={isGalleryOpen} onClose={() => setIsGalleryOpen(false)} availableThemes={availableThemes} currentTheme={currentTheme} onThemeSelect={handleThemeSelectFromGallery} />
    </div>
  );
}
